...
Output from `gbuild` will look something like
    ...
    From https://github.com/nengcoin-project/nengcoin
...
[nengcoin-project/gitian.sigs.ltc](https://github.com/nengcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
