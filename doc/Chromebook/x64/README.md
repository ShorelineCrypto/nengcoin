...
```
   tar xvfz nengcoin_v1.9.0.3_chromeos_x64.tgz
...
## run GUI QT wallet in Chromebook
 ...
 ```
 hlu@penguin:~$ cd  nengcoin_v1.9.0.0_ubuntu16.04
 hlu@penguin:~/nengcoin_v1.9.0.0_ubuntu16.04$ ./nengcoin-qt &
```
...
```
   cd  nengcoin_v1.9.0.0_ubuntu16.04
...
```
After you push TAB afer word "nengc" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "nengcoin_v1.9.0.0_ubuntu16.04" auto populated for you. 
