...
By default, Linux (Beta) or Crostini runs a container for Debian 11. Below has been tested to be working in both Debian 11 and Debian 10. Because v2.2.0 wallet is static linked, it should work directly in linux beta with proper hardware versions. 
...
### arm64
```
 hlu@penguin:~$ cd nengcoin_2.2.0_arm64_linux-gnu
 hlu@penguin:~/nengcoin_2.2.0_arm64_linux-gnu$ ./nengcoin-qt &
```

### armhf
```
 hlu@penguin:~$ cd nengcoin_2.2.0_armhf_linux-gnu 
 hlu@penguin:~/nengcoin_2.2.0_armhf_linux-gnu$ ./nengcoin-qt &
```
...
```
After you push TAB afer word "nengc" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "nengcoin_2.2.0_arm64_linux-gnu" auto populated for you. 
