...
```
   tar xvfz nengcoin_v1.6.0.3_chromeos_arm.tgz
...
### arm64
```
 hlu@penguin:~$ cd  nengcoin_v1.6.0.2_u16_arm64
 hlu@penguin:~/nengcoin_v1.6.0.2_u16_arm64$ ./nengcoin-qt &
```

### armhf
```
 hlu@penguin:~$ cd  nengcoin_v1.6.0.2_u16_armhf
 hlu@penguin:~/nengcoin_v1.6.0.2_u16_armhf$ ./nengcoin-qt &
```
...
```
After you push TAB afer word "nengc" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "nengcoin_v1.6.0.2_u16_arm64" auto populated for you. 
