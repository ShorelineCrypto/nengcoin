...
wget https://github.com/ShorelineCrypto/NengCoin/releases/download/v1.4.0.4/debian10_arm64_db-4.8.30.NC.tgz
...
wget https://github.com/ShorelineCrypto/NengCoin/releases/download/v1.4.0.4/debian10_arm64_miniupnpc.tgz
...
wget https://github.com/ShorelineCrypto/NengCoin/releases/download/v1.4.0.4/debian10_arm64_openssl-1.0.0.tgz
