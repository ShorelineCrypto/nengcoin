...
```
  wget https://github.com/ShorelineCrypto/NengCoin/releases/download/v1.9.0.2/nengcoin_v1.9.0.2_android_userland_arm.tgz
  tar xvfz nengcoin_v1.9.0.2_android_userland_arm.tgz
