...
```
  wget https://github.com/ShorelineCrypto/nengcoin/releases/download/v2.4.0/nengcoin_2.4.0_android_userland_arm.tgz
  tar xvfz nengcoin_2.4.0_android_userland_arm.tgz
  cd nengcoin_2.4.0_android_userland_arm/armhf/
