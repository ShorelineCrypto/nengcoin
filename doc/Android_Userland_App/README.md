...
```
After you push TAB afer word "neng" , the android UserLand linux terminal should behave like linux in server/desktop with the full file/folder name "nengcoin_2.0.0_arm64_linux-gnu" auto populated for you. 
...
## optional - Load GUI QT wallet into windows/mac/linux Desktop Remotely
 ...
 ```
 hlu@localhost:~$ cd nengcoin_2.0.0_arm64_linux-gnu
 hlu@localhost:~/nengcoin_2.0.0_arm64_linux-gnu$ ./nengcoin-qt &
```
