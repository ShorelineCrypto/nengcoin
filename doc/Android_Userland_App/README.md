...
UserLand app offers 4 linux distros (Alpine, Arch, Debian, Ubuntu). Currently for Nengcoin android mining, two distros are supported and tested: Debian and Ubuntu. 
...
```
   cd  nengcoin_v1.7.0.2_u16_arm64
...
```
After you push TAB afer word "neng" , the android UserLand linux terminal should behave like linux in server/desktop with the full file/folder name "nengcoin_v1.7.0.2_u16_arm64" auto populated for you. 
...
## optional - Load GUI QT wallet into windows/mac/linux Desktop Remotely
 ...
 ```
 hlu@localhost:~$ cd nengcoin_v1.7.0.2_u16_arm64
 hlu@localhost:~/nengcoin_v1.7.0.2_u16_arm64$ ./nengcoin-qt &
```
