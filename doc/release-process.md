...
* Update manpages, see [gen-manpages.sh](https://github.com/nengcoin-project/nengcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Announce the release:
  ...
  - nengcoin-dev and nengcoin-dev mailing list

  - blog.nengcoin.org blog post

  - Update title of #nengcoin and #nengcoin-dev on Freenode IRC

  - Optionally twitter, reddit /r/Nengcoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/nengcoin-project/nengcoin/releases/new) with a link to the archived release notes.
