...
Nengcoin Core has an internal benchmarking framework, with benchmarks
for cryptographic algorithms such as SHA1, SHA256, SHA512 and RIPEMD160. As well as the rolling bloom filter.

After compiling nengcoin-core, the benchmarks can be run with:
`src/bench/bench_nengcoin`
...
Trig,67108864,0.000000014997003,0.000000015448112.1.000000015188842
```
