Nengcoin Core version 0.14.2 is now available from:

  <https://download.nengcoin.org/nengcoin-0.14.2.0/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://groups.google.com/forum/#!forum/nengcoin-dev>

Compatibility
==============

Nengcoin Core is extensively tested on multiple operating systems using
...
Nengcoin Core should also work on most other Unix-like systems but is not
...
Nengcoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
Testnet3 has been deprecated and replaced with Testnet4. The server port has been changed to 16379 however the RPC port remains
the same (16376).

Testnet faucets can be located at:
- http://testnet.nengcointools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/nengcoin-project/nengcoin/blob/master/src/chainparams.cpp#L220).
...
Nengcoin Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/nengcoin-project/nengcoin/blob/master/doc/zmq.md) for
...
When Nengcoin Core is out-of-sync on startup, a semi-transparent information
...
Commands sent over the JSON-RPC interface and through the `nengcoin-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`nengcoin-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/nengcoin-cli -named help command="help"
    src/nengcoin-cli -named getblockhash height=0
    src/nengcoin-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/nengcoin-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
...
The Alert System was disabled and deprecated in Nengcoin Core 0.10.4 and removed in 0.13.2. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Nengcoin Core. This was added in conjunction with
...
here, originally written for Bitcoin but can also be used for Nengcoin:
