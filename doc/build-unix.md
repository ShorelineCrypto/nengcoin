...
-----------------------
Building the dependencies and Litecoin requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Litecoin build:
```bash
$ cd depends
