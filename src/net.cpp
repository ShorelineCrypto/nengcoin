...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NewEnglandcoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x0100007f,0x1316ca90,0x58691c4c,0x9ee19744,0x0224714a,0x3115dccb,0xd3f9ff49
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NewEnglandcoin is probably already running."), addrBind.ToString().c_str());
        else
