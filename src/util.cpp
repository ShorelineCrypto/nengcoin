...
const char * const BITCOIN_CONF_FILENAME = "nengcoin.conf";
const char * const BITCOIN_PID_FILENAME = "nengcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nengcoin";
#else
    // Unix
