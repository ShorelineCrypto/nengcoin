...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    if ((pindexLast->nHeight+1) % nInterval != 0)
    {
        ...
        else if (pindex->nHeight > 5287700) {
            CBigNum bnCheetah;
            bnCheetah = bnProofOfWorkLimit;
            bnCheetah /= 1;
            unsigned int nCheetah = bnCheetah.GetCompact();
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Check timestamp - Enforce v1.10.x timestamp 2 minute rule after v1.10.x hard fork
    if (GetBlockTime() > GetAdjustedTime() + 1 * 2 * 55)
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x34de440b80c77cb1289abb3cb597b979dbcd0c316ab7fe6091570f00e74b8da1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048a1df6f0046eafaad23b2f0b6e0d4964dda515c26dd2e19e2db9f7584c07799d8c978c1f8e21e5c9d168ebe2b084cf86024e253aaad2a485833869359788ebf4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1536025237;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084724027;

        if (fTestNet)
        {
            block.nTime    = 1536025158;
            block.nNonce   = 385712497;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xdc51d0c4bddd44497f37a4841aac0bc88bf56ce4b8be04c22ec9399168c97fbc"));
        block.print();
