...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nengcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nengcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nengcoin transaction") + "\n" +
              "  nengcoin-tx [options] -create [commands]   " + _("Create hex-encoded nengcoin transaction") + "\n" +
              "\n";
