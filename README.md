...
Major releases features:
 ...
 - v1.13.x cheetah diff drop 20x, spike increase 2x

Current full version name: "1.13.1.0_randomSpike-v1.13.x" (shorthand: "v1.13.x")
Note: latest different platform wallets have "1.13.1.0" version tag in QT wallet.  The downloaded files should have correct version on file names supporting different hardware devices and OS.
